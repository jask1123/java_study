 ...
 * Generated at: 2023-06-06 02:22:22 UTC
...
public final class answer_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    int correctAnswer = 5050; // 1ãã100ã¾ã§ã®æ°å¤ã®åè¨

    if (userAnswer != null && userAnswer.equals(String.valueOf(correctAnswer))) {
        response.sendRedirect("correct.jsp"); // æ­£è§£ã®ç»é¢ã«ãªãã¤ã¬ã¯ã
    } else {
        String searchQuery = "https://www.google.com/search?q=" + userAnswer;
        response.sendRedirect(searchQuery); // Googleã®æ¤ç´¢ç»é¢ã«ãªãã¤ã¬ã¯ã
    }
